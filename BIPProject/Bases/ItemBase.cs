...
namespace BossItemsPlus.Bases
{
    ...
    public abstract class ItemBase
    {
        ...
        protected void CreateItem()
        {
            ...
            {
                Main.BlacklistedFromPrinter.Add(ItemDef);
            }
        ...
        public static void BlacklistFromPrinter(ILContext il)
        {
            ...
            if (gotThisIndex && gotListIndex)
            {
                ...
                c.EmitDelegate<Action<ShopTerminalBehavior, List<PickupIndex>>>((shopTerminalBehavior, list) =>
                {
                    ...
                    {
                        list.RemoveAll(x => Main.BlacklistedFromPrinter.Contains(ItemCatalog.GetItemDef(PickupCatalog.GetPickupDef(x).itemIndex)));
                    }
                });
            }
        }
